...
def main():
    ...
    optimize_parser.add_argument('--evals', type=int, default=5, help='Total number of evaluations.')
    optimize_parser.add_argument('--init_points', type=int, default=1, help='Number of initial LHS points.')
    optimize_parser.add_argument('--batch_size', type=int, default=2, help='Number of parallel evaluations per batch (q).')
