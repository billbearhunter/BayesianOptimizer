...
def main():
    ...
    optimize_parser.add_argument('--evals', type=int, default=1000, help='Total number of evaluations.')
    optimize_parser.add_argument('--init_points', type=int, default=50, help='Number of initial LHS points.')
    optimize_parser.add_argument('--batch_size', type=int, default=10, help='Number of parallel evaluations per batch (q).')
