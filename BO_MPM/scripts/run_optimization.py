...
from config.config import XML_TEMPLATE_PATH, DEFAULT_OUTPUT_DIR, MIN_N, MAX_N, MIN_ETA, MAX_ETA, MIN_SIGMA_Y, MAX_SIGMA_Y

def run_optimization(width, height, sampling_number, seed, output_dir=DEFAULT_OUTPUT_DIR, max_displacement=10.0):
    """
